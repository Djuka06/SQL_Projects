...
The goal of this project is : Data Cleaning in SQL queries.
As a dataset I used Nashville Housing Data from Kaggle.
...
-- If it doesn't update properly do the following
